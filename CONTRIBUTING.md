...
Generic UI Items - Core State Integration is bridge code between Generic UI Items and Core State.

Keep Generic UI Items independent from Core State. Keep Core State independent from Generic UI Items. Do not add references from either core package back to this integration package.
...
- Keep runtime changes focused on integration.
